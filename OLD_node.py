        ...
        while waiting_for_input:
            ...
            if user_choice == "1":
                ...
                if not self.blockchain.mine_block():
                    print("Mining failed! Maybe you have no wallet?")
            elif user_choice == "3":
                ...
                print(
                    "Input was invalid, please choose an input from the provided list!"
                )
            if not Verification.verify_chain(self.blockchain.chain):
                self.print_blockchain_elements()
                print("Invalid loop, blockchain verification failed!")
                break
            print(
